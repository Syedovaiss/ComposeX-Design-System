...
/**
 * ComposeX Filled Tonal Button component following the design system
 * Button with a lighter background color, lower contrast than filled button
 *
...
fun ComposeXFilledTonalButton(
    ...
    FilledTonalButton(
        ...
        colors = ButtonDefaults.filledTonalButtonColors(
            containerColor = params.backgroundColor.copy(alpha = 0.6f),
